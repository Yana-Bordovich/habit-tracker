...
export const DumbbellIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.4 14.4 9.6 9.6"/><path d="M18.657 21.485a2 2 0 1 1-2.829-2.828l-1.767 1.768a2 2 0 1 1-2.829-2.829l6.364-6.364a2 2 0 1 1 2.829 2.829l-1.768 1.767a2 2 0 1 1 2.828 2.829z"/><path d="m21.5 21.5-1.4-1.4"/><path d="m3.9 3.9 1.4 1.4"/><path d="M6.808 12.727a2 2 0 1 1-2.829-2.829l5.657-5.657a2 2 0 1 1 2.829 2.829l-5.657 5.657z"/></svg>
);
...
export const MeditateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 21a9 9 0 1 0-9-9c0 2.4.9 4.6 2.5 6.2"/><path d="M8 12h8"/><path d="M9.1 7.8c.4.6.6 1.4.6 2.2 0 .8-.2 1.6-.6 2.2"/><path d="M14.9 7.8c-.4.6-.6 1.4-.6 2.2 0 .8.2 1.6.6 2.2"/><path d="M12 12v1.5a2.5 2.5 0 0 0 5 0V12a9 9 0 0 0-9 9"/></svg>
);
